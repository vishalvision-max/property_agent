...
class LeadApiService {
  static const String baseUrl =
      'https://propertysearch.visionvivante.in/api/v1/buyer-leads';

  static const String token =
      '322|RIpR6P4tzMRTi1OGwO86Z2odDXu2jVY7SfeFjfAnf5ac8c6e';
...
final myLeadsProvider = FutureProvider<List<Lead>>((ref) async {
  return LeadApiService.fetchLeads();
});
