...
void main() async {
  ...
  final formData = FormData.fromMap({
    ...
    'listing_type': 'owner',
    'title': 'Test Farmhouse Nested Keys',
    'description': 'Testing nested plot_details',
    'price': '300',
    'area': '200',
    'area_unit': 'sqft',
    ...
    'latitude': '30.717',
    'longitude': '76.850',
    'plot_details[farm_land_area]': '500',
    'plot_details[farm_rooms]': '5',
    'plot_details[farm_utilities][]': 'water_source',
    'balconies': '3',
  });
